<header class="sticky top-0 z-40 bg-white border-b border-zinc-200">
  <div class="container-portal flex items-center justify-between h-16">
    <a href="#" class="flex items-center gap-2 font-semibold text-lg text-zinc-900">
    ...
    <nav class="hidden md:flex items-center gap-2">
      <a href="#so-funktionierts" class="btn-ghost">So funktioniert's</a>
      <a href="#preis" class="btn-ghost">Preis</a>
  ...
  <div id="menu" class="hidden md:hidden border-t border-zinc-200 bg-white">
    <div class="container-portal py-3 flex flex-col gap-1">
      <a href="#so-funktionierts" class="btn-ghost justify-start">So funktioniert's</a>
      <a href="#preis" class="btn-ghost justify-start">Preis</a>
      <a href="#faq" class="btn-ghost justify-start">Fragen und Antworten</a>
